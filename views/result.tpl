    ...
    <body>
        ...
        <div class="row">
            <div class="card fluid">
                ...
                <ul class="note">
                    <li>周回数 <code>000周</code> およびクエスト名はツイートボタンを押した後に Twitter の投稿画面上で書き換えてください。</li>
                    <li>礼装、種火、また画像の片方が未ドロップの素材。これらは個数の判定が不可能なため <code>NaN</code> と表記されます。投稿時に項目ごと削るか、適切な数字に書き換えてください。</li>
